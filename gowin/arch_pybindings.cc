...
void arch_wrap_python(py::module &m)
{
    ...
    typedef std::vector<PipId> PipRange;
    typedef std::vector<PipId> AllPipRange;
    typedef std::vector<BelPin> BelPinRange;
    typedef std::vector<BelId> BelRange;
    typedef std::vector<WireId> WireRange;
